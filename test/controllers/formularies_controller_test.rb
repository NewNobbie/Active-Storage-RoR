...
class FormulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulary" do
    assert_difference("Formulary.count") do
      post formularies_url, params: { formulary: { description: @formulary.description, title: @formulary.title } }
    end
  ...
  test "should update formulary" do
    patch formulary_url(@formulary), params: { formulary: { description: @formulary.description, title: @formulary.title } }
